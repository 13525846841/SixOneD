...
public abstract class PullToRefreshBase<T extends View> extends LinearLayout implements IPullToRefresh<T> {
	 ...
	 * method and return an getInstance of your custom class.
	 * <p/>
	 ...
	 *            created View
	 * @return New getInstance of the Refreshable View
	 */
	 ...
	 * classes can handle their saved getInstance state.
	 * 
	 * @param savedInstanceState - Bundle which contains saved getInstance state.
	 */
