...
public class DefaultConfigurationFactory {
    ...
    public static DiscCacheAware createDiscCache(Context context, FileNameGenerator discCacheFileNameGenerator, int discCacheSize, int discCacheFileCount) {
        if (discCacheSize > 0) {
            File individualCacheDir = StorageUtils.getHealthTalkExternalCacheDir(DoctorHelper.getAccount());
            ...
            File cacheDir = StorageUtils.getHealthTalkExternalCacheDir(DoctorHelper.getAccount());
    ...
    public static File createDefaultCacheDir(Context context) {
        File file = StorageUtils.getHealthTalkExternalCacheDir(DoctorHelper.getAccount());
        return file;
    }
	...
	*//**
	...
	public static DisplayImageOptions createPrizeDraw(){
		...
		.bitmapConfig(Bitmap.Config.RGB_565)
		.displayer(new RoundedBitmapDisplayer(5))
		.build(AppContext.getHTalkApplication());
		return options;
	}
	...
	*/
    ...
    public static DisplayImageOptions createUnknowNineHeaderDisplayImageOptions() {
        DisplayImageOptions displayImageOptions = new DisplayImageOptions.Builder(AppContext.getApplication())
                .showStubImage(R.drawable.default_jiugong_icon)
                .bitmapConfig(Bitmap.Config.RGB_565)
                .cacheOnDisc(new File(StorageUtils.getHeadersPath()))
                .cacheInMemory()
    ...
    public static DisplayImageOptions patientPicDisplayImageOptions(Context context) {
        DisplayImageOptions options = new DisplayImageOptions.Builder(context)
                .showStubImage(R.drawable.default_head_patient)
                .cacheOnDisc(new File(StorageUtils.getImagePath()))
                .bitmapConfig(Bitmap.Config.RGB_565)
                .displayer(new RoundedBitmapDisplayer(1))
                .cacheInMemory()
    ...
    public static DisplayImageOptions doctorPicDisplayImageOptions(Context context) {
        DisplayImageOptions options = new DisplayImageOptions.Builder(context)
                .showStubImage(R.drawable.default_head_doctor)
                .cacheOnDisc(new File(StorageUtils.getImagePath()))
                .bitmapConfig(Bitmap.Config.RGB_565)
                .displayer(new RoundedBitmapDisplayer(1))
                .cacheInMemory()
    ...
    public static DisplayImageOptions createSeniorDoctorDisplayImageOptions(Context context) {
        DisplayImageOptions options = new DisplayImageOptions.Builder(context)
                .showStubImage(R.drawable.default_head_female)
                .cacheOnDisc(new File(StorageUtils.getImagePath()))
                .bitmapConfig(Bitmap.Config.RGB_565)
