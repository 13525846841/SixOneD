...
public final class ImageLoaderConfiguration {
	...
	private ImageLoaderConfiguration(final Builder builder) {
		...
		downRootUrlPath = AppContext.getApiRepository().URL_QUERYHEADIMAGE;//下载根路径
	...
	public static class Builder {
		 ...
		 * <b>NOTE: Use this option only when you have appropriate needs. It can make GlideHelper slower.</b>
		 * 
		...
		/**
		 * GlideHelper try clean memory and re-display image it self when {@link OutOfMemoryError} occurs. You can
		 * switch off this feature by this method and process connectError by your way (you can know that
