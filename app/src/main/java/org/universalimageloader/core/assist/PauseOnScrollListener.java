 ...
 * {@linkplain ImageLoader#pause() pause GlideHelper's tasks} while list view is scrolling (touch scrolling and/or
...
public class PauseOnScrollListener implements OnScrollListener {
	 ...
	 * Constructor
	 * 
	 * @param pauseOnScroll Whether {@linkplain ImageLoader#pause() pause GlideHelper} during touch scrolling
	 * @param pauseOnFling Whether {@linkplain ImageLoader#pause() pause GlideHelper} during fling
	 */
