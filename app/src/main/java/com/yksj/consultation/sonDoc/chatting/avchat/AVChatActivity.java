...
import com.yksj.consultation.sonDoc.chatting.avchat.faceunity.FaceU;
import com.yksj.consultation.sonDoc.chatting.avchat.receiver.PhoneCallStateObserver;
import com.yksj.consultation.sonDoc.chatting.avchat.widgets.AVChatNotification;
...
public class AVChatActivity extends UI implements AVChatUI.AVChatListener, AVChatStateObserver, AVChatSurface.TouchZoneCallback {
    ...
    private static final String KEY_ACCOUNT_ORDERID = "KEY_ACCOUNT_ORDERID";
    ...
    public static void launch(Context context, String account, int callType, String order_Id, int source) {
        needFinish = false;
        Intent intent = new Intent();
        intent.addFlags(Intent.FLAG_ACTIVITY_SINGLE_TOP | Intent.FLAG_ACTIVITY_NEW_TASK);
        intent.setClass(context, AVChatActivity.class);
        intent.putExtra(KEY_ACCOUNT_ORDERID, order_Id);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        order_id = getIntent().getStringExtra(KEY_ACCOUNT_ORDERID);
        avChatUI = new AVChatUI(this, root, order_id, this);
...
//        activeCallingNotifier();
    ...
    Observer<AVChatCalleeAckEvent> callAckObserver = new Observer<AVChatCalleeAckEvent>() {
        ...
        public void onEvent(AVChatCalleeAckEvent ackInfo) {
            ...
            if (ackInfo.getEvent() == AVChatEventType.CALLEE_ACK_BUSY) {
                ...
                CoreService.setActionVideoTip(AVChatActivity.this, 0L, 0L);
            }
        }
    };
    ...
    protected void handleWithConnectServerResult(int auth_result) {
        LogUtils.i(TAG, "result code->" + auth_result);
        if (auth_result == 200) {
