...
import com.yksj.consultation.sonDoc.chatting.avchat.init.CustomAttachParser;
import com.yksj.consultation.sonDoc.chatting.avchat.viewholder.SessionCustomization;
...
//            if (BrowserSpace.VERSION.SDK_INT >= BrowserSpace.VERSION_CODES.ICE_CREAM_SANDWICH) {
