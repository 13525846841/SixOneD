package com.yksj.consultation.sonDoc.chatting.avchat.faceunity;
...
import com.yksj.consultation.sonDoc.chatting.avchat.adapter.EffectAndFilterSelectAdapter;
import com.yksj.consultation.sonDoc.chatting.avchat.utils.NimSingleThreadExecutor;
import com.yksj.consultation.sonDoc.chatting.avchat.utils.ThreadUtils;
...
public class FaceU {
    ...
    private void initFaceU() {
        ...
        try {
            ...
            Log.i(TAG, "initialize faceU done");
        } catch (IOException e) {
            e.printStackTrace();
        }
    }
