...
import com.yksj.consultation.sonDoc.R.color;
 ...
 *
 */
public class PConsultApplyActivity extends BaseActivity implements OnClickListener{
    ...
    private void initStageData(String consultationId){
        ApiService.doHttpfindConsuStatusList(consultationId,new ObjectHttpResponseHandler(PConsultApplyActivity.this) {
            @Override
            ...
            for(int i=0;i<array.length();i++){
                ...
                switch (stated){
                    case 1:
                        break;
                    case 10://提前申请
                        text61.setTextColor(getResources().getColor(color.color_text1));
//                        text61.setText(object.optString("AFTER_ORDER_STATUS"));
                        ...
                        break;
                    case 20://医生助理接诊
                        text62.setTextColor(getResources().getColor(color.color_text1));
                        ...
                        break;
                    case 50://填写病历
                        text63.setTextColor(getResources().getColor(color.color_text1));
                        ...
                        break;
                    case 70://等待专家接诊
                        text64.setTextColor(getResources().getColor(color.color_text1));
                        ...
                        break;
                    case 80://支付
                        text65.setTextColor(getResources().getColor(color.color_text1));
                        ...
                        break;
                    case 99://专家给出建议
                        text66.setTextColor(getResources().getColor(color.color_text1));
