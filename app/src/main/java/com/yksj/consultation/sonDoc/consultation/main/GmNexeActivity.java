...
public class GmNexeActivity extends BaseActivity implements View.OnClickListener {
    ...
    private void initView() {
        ...
        EditTextUtil.setEditTextInhibitInputSpeChat(edit_bank_number,this);
    }
...
//        }
        ...
        ApiService.OKHttpEmbodyMoney(map, new ApiCallback<String>() {
            @Override
