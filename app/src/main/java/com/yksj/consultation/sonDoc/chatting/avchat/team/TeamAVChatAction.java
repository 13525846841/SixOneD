...
import com.yksj.consultation.sonDoc.chatting.avchat.activity.TeamAVChatActivity;
import com.yksj.consultation.sonDoc.chatting.avchat.cache.DemoCache;
import com.yksj.consultation.sonDoc.chatting.avchat.cache.SimpleCallback;
import com.yksj.consultation.sonDoc.chatting.avchat.cache.TeamDataCache;
import com.yksj.healthtalk.utils.StringUtil;
...
//                        NimUIKit.startContactSelect(getActivity(), getContactSelectOption(tid), TeamRequestCode.REQUEST_TEAM_VIDEO);
    ...
    public void onSelectedAccountsResult(Activity activity, final ArrayList<String> accounts, final String groupId) {
        ...
        AVChatManager.getInstance().createRoom(roomName, "", new AVChatCallback<AVChatChannelInfo>() {
            @Override
            public void onSuccess(AVChatChannelInfo avChatChannelInfo) {
                ...
                TeamAVChatActivity.startActivity(activity, false, transaction.getTeamID(), roomName, accounts, "123");
...
//    }
    ...
    private void onCreateRoomSuccess(String roomName, List<String> accounts,String id) {
