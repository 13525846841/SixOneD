 ...
 */
public class PConsultCouponActivity extends BaseTitleActivity implements View.OnClickListener {
    ...
    private void initData() {
        ...
        //valuePairs.add(new BasicNameValuePair("CUSTOMERID", LoginServiceManeger.getInstance().getLoginEntity().getId()));
      ...
      //  valuePairs.add(new BasicNameValuePair("CONSULTATIONID", consultId));//consultId
        ...
        ApiService.doGetConsultationCouponsList(valuePairs, new ApiCallback<String>() {
            @Override
