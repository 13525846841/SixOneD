 ...
 *
 */
public class ConsultationBackPayActivity extends BaseActivity implements OnClickListener {
	...
	private void initData() {
		...
		ApiService.doHttpSubmitCaseTemplate(params,new AsyncHttpResponseHandler(this){
			@Override
	...
	private void actionSumit() {
		...
		ApiService.doHttpConsultationBackPay(params, new AsyncHttpResponseHandler(this){
			@Override
