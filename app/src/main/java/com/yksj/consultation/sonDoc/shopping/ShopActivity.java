 ...
 * 商城界面
 */
public class ShopActivity extends BaseActivity implements View.OnClickListener, TextView.OnEditorActionListener, AdapterView.OnItemClickListener {
    public static final int REQUEST_GOODS_CODE_ONE = 2003;//商品推荐
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.title_back:
                ...
                break;
            case R.id.main:
//                Intent intent = new Intent(ShopActivity.this,AtyConsultMain.class);
...
//                findViewById(R.id.shop_main).setVisibility(View.GONE);
