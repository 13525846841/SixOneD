...
import com.yksj.consultation.sonDoc.views.MovieRecorderView;
...
public class RecordShowAty extends BaseActivity {
    ...
    public RecordShowAty() {
    }

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.aty_recordshow);
        initViews();
        initEvents();
        init();
