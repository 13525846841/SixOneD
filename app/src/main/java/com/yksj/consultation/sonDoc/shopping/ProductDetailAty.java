...
import com.yksj.consultation.sonDoc.consultation.InternetVideoDemo;
 ...
 * 购物车 商品详情
 */
public class ProductDetailAty extends BaseActivity implements View.OnClickListener, ViewPager.OnPageChangeListener {
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.title_back:
                onBackPressed();
                break;
            case R.id.shopping://推荐给患者
                EventBus.getDefault().post(new GoodsEvent(goodId, 1));
                finish();
                break;
