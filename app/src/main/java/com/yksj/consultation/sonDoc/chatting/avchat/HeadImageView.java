...
public class HeadImageView extends CircleImageView {
    ...
    public void loadAvatar(final String url) {
        doLoadImage(url, R.drawable.default_head_doctor, DEFAULT_AVATAR_THUMB_SIZE);
    }
    ...
    public void loadBuddyAvatar(String account) {
        ...
        doLoadImage(userInfo != null ? userInfo.getAvatar() : null, R.drawable.default_head_doctor, DEFAULT_AVATAR_THUMB_SIZE);
    }
