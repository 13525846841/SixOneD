 ...
 *
 */
public class DoctorClinicMainActivity extends BaseActivity implements OnClickListener{
...
//		AnimationUtils.startGuiPager(this, getClass().getAccount());
	...
	private void initData(String type, String qrCode, String id) {
		ApiService.doHttpFindCustomerInfoByCustId(type, qrCode, id,
...
//		}
		...
		if(praiseFlag){
			...
			tvAddPraise.setTextColor(DoctorClinicMainActivity.this.getResources().getColor(R.color.color_blue));
		}
...
//		ocs.show();
	...
	private void praise() {
		...
		ApiService.doHttpOperatePraiseToFriend(DoctorClinicMainActivity.this, praiseFlag, mInfoEntity,
			...
			public void onSuccess(int statusCode,
				...
				if(response!=null&&!response.toString().contains("error_message")){
					if(praiseFlag){
						...
						drawable.setBounds(0, 0, drawable.getMinimumWidth(), drawable.getMinimumHeight());
						tvAddPraise.setCompoundDrawables(drawable,null,null,null);
						tvAddPraise.setTextColor(DoctorClinicMainActivity.this.getResources().getColor(R.color.color_text_gray));
					}else{
						praiseCount++;
						Drawable drawable= getResources().getDrawable(R.drawable.clinic_icon_add_praised);
						drawable.setBounds(0, 0, drawable.getMinimumWidth(), drawable.getMinimumHeight());
