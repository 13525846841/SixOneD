...
import com.yksj.consultation.sonDoc.friend.FriendSearchResultActivity;
 ...
 *
 */
public class PersonInfoActivity extends BaseActivity implements OnClickListener, OnItemClickListener {
...
//					mBlack_bt.setText("拉黑");
	...
	private void initData(String type , String qrCode ,String id) {
		ApiService.doHttpFindCustomerInfoByCustId(type,qrCode,id,SmartFoxClient.getLoginUserId(),
