 ...
 */
public class DoubleInviteAlertDialog implements View.OnClickListener {
    ...
    public DoubleInviteAlertDialog(Builder builder) {
        mBuilder = builder;
        ...
        cancel = (Button) mDialogView.findViewById(R.id.cancel);
    ...
    public static class Builder {
        ...
        public DoubleInviteAlertDialog build() {
            return new DoubleInviteAlertDialog(this);
        }
