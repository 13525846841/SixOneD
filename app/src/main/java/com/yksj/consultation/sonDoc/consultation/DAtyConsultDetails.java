...
import com.yksj.consultation.sonDoc.consultation.DFgtConsultApplyForm.SwitchFragmentListener;
 ...
 *         会诊详情页
 */
public class DAtyConsultDetails extends BaseActivity implements OnClickListener, OnCheckedChangeListener,
	...
	private void initView() {
		...
		LogUtils.e("CONID", conId + "");
		LogUtils.e("HEKL", type + "");
		// 标题
		initializeTitle();
...
//		}
	...
	private void assistantLoadData() {
		ApiService.doHttpServerDetailServlet(conId + "", new ObjectHttpResponseHandler() {
			JSONObject object;
					...
					if (object.has("errormessage")) {
						...
						if (isDoctor) {
							if ("0".equals(SmartFoxClient.getLoginUserInfo().getDoctorPosition())&& object.has("EXPERT")
									&& object.has("PATIENT")) {
								LogUtils.e(this.getClass().getName(),SmartFoxClient.getLoginUserInfo().getDoctorPosition()+"");
