...
import com.yksj.consultation.sonDoc.chatting.avchat.ImageLoaderKit;
import com.yksj.consultation.sonDoc.chatting.avchat.cache.DataCacheManager;
import com.yksj.consultation.sonDoc.chatting.avchat.module.input.StorageUtil;
...
//            DataCacheManager.buildDataCache(); // build data cache on auto onLoginClick
//            getImageLoaderKit().buildImageCache(); // build image cache on auto onLoginClick
//        }

        // initialize tools
        StorageUtil.init(context, null);
        ScreenUtil.init(context);
//        StickerManager.getInstance().initialize();

        // initialize log
//        String path = StorageUtil.getDirectoryByDirType(StorageType.TYPE_LOG);
//        LogUtil.initialize(path, Log.DEBUG);
    }
