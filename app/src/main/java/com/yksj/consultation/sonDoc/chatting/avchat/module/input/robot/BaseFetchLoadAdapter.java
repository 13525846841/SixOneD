package com.yksj.consultation.sonDoc.chatting.avchat.module.input.robot;
...
import com.yksj.consultation.sonDoc.chatting.avchat.module.input.robot.animation.AlphaInAnimation;
import com.yksj.consultation.sonDoc.chatting.avchat.module.input.robot.animation.BaseAnimation;
import com.yksj.consultation.sonDoc.chatting.avchat.module.input.robot.animation.ScaleInAnimation;
import com.yksj.consultation.sonDoc.chatting.avchat.module.input.robot.animation.SlideInBottomAnimation;
import com.yksj.consultation.sonDoc.chatting.avchat.module.input.robot.animation.SlideInLeftAnimation;
import com.yksj.consultation.sonDoc.chatting.avchat.module.input.robot.animation.SlideInRightAnimation;
import com.yksj.consultation.sonDoc.chatting.avchat.utils.RecyclerViewUtil;
...
public abstract class BaseFetchLoadAdapter<T, K extends BaseViewHolder> extends RecyclerView.Adapter<K> implements IRecyclerView, View.OnClickListener {
    ...
    /**
     * setting up a new getInstance to data;
     *
     * @param data
     */
