...
public class MyFriendListFragment extends BaseFragment implements OnRefreshListener2<ListView>, OnItemClickListener{
	...
	BroadcastReceiver receiver = new BroadcastReceiver() {
		...
		public void onReceive(Context context, Intent intent) {
			...
			if (action.equals(MessagePushService.ACTION_COLLECT_FRIEND)) {
				WaitDialog.dismiss(getFragmentManager());
...
//				}
				...
				DoubleBtnFragmentDialog.showDefault(getChildFragmentManager(),  "亲，您的好评是对我们最大的鼓励~", "下次吧", "鼓励一下",new OnDilaogClickListener() {
					...
					public void onDismiss(DialogFragment fragment) {
						SharePreHelper.updateCommentGoodDay();
					}
					@Override
					public void onClick(DialogFragment fragment, View v) {
						SharePreHelper.updateCommentGood();
...
//		filter.addAction(SFSEvent.CONNECTION_LOST);
	...
	private void initData() {
		...
		case 1://我关注的
			...
			params.put("NAME", "");
			ApiService.doHttpFINDMYFOCUSFRIENDS(params,new ResponData());
			break;
		case 2://我的粉丝
			params.put("CUSTOMERID", SmartFoxClient.getLoginUserId());
			params.put("PAGENUM",String.valueOf(PAGENUM));
			params.put("PAGESIZE", String.valueOf(PAGESIZE));
			ApiService.doHttpFINDMYFRIENDS32(params,new ResponData());
			break;
		case 3://我的黑名单
			params.put("CUSTOMERID", SmartFoxClient.getLoginUserId());
			params.put("PAGENUM",String.valueOf(PAGENUM));
			params.put("PAGESIZE", String.valueOf(PAGESIZE));
			ApiService.doHttpFINDMYBLACK32(params,new ResponData());
			break;
		}
	}
