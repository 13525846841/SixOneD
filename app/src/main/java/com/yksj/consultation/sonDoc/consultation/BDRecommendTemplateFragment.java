 ...
 * @author lmk
 */
public class BDRecommendTemplateFragment extends BaseFragment {
	...
	private void submitTemplate() {
		...
		ApiService.doHttpConsultionCaseTemplate("5",itemId, consultationId, new AsyncHttpResponseHandler(getActivity()){
	...
	private void initData() {
		ApiService.doHttpConsultionCaseTemplate("4",null, consultationId, new AsyncHttpResponseHandler(getActivity()){
