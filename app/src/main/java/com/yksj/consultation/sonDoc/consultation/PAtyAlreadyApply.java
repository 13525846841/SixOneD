 ...
 * 
 */
public class PAtyAlreadyApply extends BaseActivity implements OnClickListener {
...
//		AnimationUtils.startGuiPager(this, getClass().getAccounts());
	...
	public void onClick(View v) {
		...
		case R.id.btn_fillCaseDeleteServer0:
			...
			intent = new Intent(this, AtyConsultReject.class);
	...
	private void applyFormLoadData() {
		ApiService.doHttpServerDetailServlet(conID + "", new ObjectHttpResponseHandler(this) {
			JSONObject object;
