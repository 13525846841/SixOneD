 ...
 */
public class AtyDossierDetails extends BaseActivity implements View.OnClickListener,
    ...
    private void initData() {
        ...
        ApiService.doHttpConsultionCaseTemplateShare(params, new AsyncHttpResponseHandler(AtyDossierDetails.this) {
