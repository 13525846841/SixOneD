...
//                        shanhou();
						...
						/**
						 * 2017/3/14 此处-1为我加的，否侧数组角标越界，但是为什么以前没有问题呢
						 */
...
//				}
	...
	private void queryOffice() {
		...
		valuePairs.add(new BasicNameValuePair("CUSTOMERID", DoctorHelper.getId()));
		ApiService.doGetConsultationInfoSet(valuePairs, new MyApiCallback<JSONObject>(getActivity()) {
