 ...
 * @author zheng
 */
public class ConsultationServiceListFragment extends BaseFragment implements OnRefreshListener2<ListView>{
	...
	private void initData(int type,int pagesize){
		ApiService.doHttpFindMyConsuServiceList1(type, pagesize, new ObjectHttpResponseHandler(mActivity) {
