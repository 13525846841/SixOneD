...
import com.yksj.healthtalk.function.decoding.CaptureActivityHandler;
import com.yksj.healthtalk.function.decoding.InactivityTimer;
 ...
 * 
 */
public class FriendSearchAboutZxingActivity extends BaseActivity
	...
	private String type;// 0-社交场 1-医生馆 2 商户 3全局搜索
...
//		titleRightBtn2.setVisibility(View.VISIBLE);
	...
	private void parseResult(String str) {
		...
		if (!TextUtils.isEmpty(res) && res.equalsIgnoreCase("yijiankang")) {
...
//			finish();
	...
	private void FindCustomerInfoByCustId(String code) {
		ApiService.doHttpFindCustomerInfoByCustId(type, code, null,
...
//								}
	...
	public void FindServerMerchant(String code) {
		ApiService.doHttpServerMerchant(String.valueOf(dm.widthPixels),
...
//									FriendSearchAboutZxingActivity.this,
//									ServerCenterMainActivity.class);
