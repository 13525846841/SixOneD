...
public final class CameraManager {
  ...
  static final int SDK_INT; // Later we can use BrowserSpace.VERSION.SDK_INT
  static {
    int sdkInt;
    try {
  ...
  /**
   * Gets the CameraManager singleton getInstance.
   *
  ...
  private CameraManager(Context context) {
    ...
    //useOneShotPreviewCallback = Integer.parseInt(BrowserSpace.VERSION.SDK) > BrowserSpace.VERSION_CODES.CUPCAKE;
...
//      FlashlightManager.disableFlashlight();
  ...
  /**
   * Tells the camera to stopRecorder drawing preview frames.
   */
...
//      rect.bottom = rect.bottom * cameraResolution.y / screenResolution.y;
   ...
   * @return A PlanarYUVLuminanceSource getInstance.
   */
