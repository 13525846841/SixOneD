...
public class SettingManager {
	 ...
	 */
	private void init() {
		userid = DoctorHelper.getId();
		settingConfig = settingConfig + userid;
		sharedPreferences = SharePreHelper.getSharePreFernces(
				AppContext.getApplication(), settingConfig);
		...
		// sharedPreferences =
		// SharePreHelper.getSharePreFernces(context,settingConfig);
...
//		 isNetWorkAvailab = SystemUtils.isNetworkAvailable(context);
	...
	private void onUpdatePrefer(String key, boolean value) {
		SharePreHelper.saveBoolean(this.sharedPreferences, key, value);
	}
