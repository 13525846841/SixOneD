...
public class BitmapDrawableCache {
	 private static final String TAG = "BitmapDrawableCache";
	    ...
	    public void setLimit(long new_limit){
	        limit=new_limit;
	        LogUtils.i(TAG, "MemoryCache will use up to "+limit/1024./1024.+"MB");
	    }
	    ...
	    private void checkSize() {
	    	LogUtils.i(TAG, "cache size="+size+" length="+cache.size());
	        if(size>limit){
	            ...
	            LogUtils.i(TAG, "Clean cache. New size "+cache.size());
	        }
	    }
