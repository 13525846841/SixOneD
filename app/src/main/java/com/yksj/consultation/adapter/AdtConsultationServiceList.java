...
import com.yksj.consultation.sonDoc.consultation.PAtyAlreadyApply;
 ...
 * @author zheng
 */
public class AdtConsultationServiceList extends SimpleBaseAdapter<ConsultationServiceEntity> implements
        OnClickListener, SalonSelectPaymentOptionActivity.OnBuyTicketHandlerListener {
...
//		case 0://全部中
    ...
    private void popData(final View view, String consultationId) {
        ApiService.doHttpServerDetailServletChatMessage(consultationId, new AsyncHttpResponseHandler(
