...
//        }
//        //图片展示
//        String url= AppContext.getmRepository().URL_QUERYHEADIMAGE_NEW+list.get(position).optString("PICS");
...
//            String url = AppContext.getmRepository().DOWNLOADPIC_NEW+smallUrls.get(i);
//            mInstance.displayImage(url, img, mOptions);
