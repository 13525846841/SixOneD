...
import com.yksj.consultation.sonDoc.chatting.avchat.HeadImageView;
import com.yksj.consultation.sonDoc.chatting.avchat.common.NimUIKit;
import com.yksj.consultation.sonDoc.chatting.avchat.team.TeamAVChatVoiceMuteItem;
...
public class TeamAVChatVoiceMuteAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        UserInfo userInfo = NimUIKit.getUserInfoProvider().getUserInfo(item.getAccount());
