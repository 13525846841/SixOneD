...
import com.yksj.consultation.sonDoc.consultation.DAtyConsultMessageEdit;
...
public class DynamicMesAllAdapter extends SimpleBaseAdapter<DynamicMessageListEntity> {
	...
	public View getItemView(final int position, final View convertView, ViewHolder holder) {
		...
		if (type!=2&&mAlreadyRead.containsKey(id)){
			messtitle.setTextColor(maActivity.getResources().getColor(R.color.color_text_gray));}
		else{messtitle.setTextColor(Color.BLACK);}
		// 图片展示
