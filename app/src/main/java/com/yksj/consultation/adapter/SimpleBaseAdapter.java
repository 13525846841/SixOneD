...
public abstract class SimpleBaseAdapter<T> extends BaseAdapter {
    ...
    public List<File> mDatas=new ArrayList<>();
    public Context context;
    public String type = "";//1视频2图片3文档
    ...
    public void onBoundData(List<T> datas, String type) {
        this.datas.clear();
        this.datas.addAll(datas);
        this.type = type;
        notifyDataSetChanged();
    ...
    public void onBoundData(List<T> datas, List<File> datas2, String type) {
        this.datas.clear();
        this.datas.addAll(datas);
        this.mDatas.clear();
