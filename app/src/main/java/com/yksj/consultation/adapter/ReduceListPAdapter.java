 ...
 */
public class ReduceListPAdapter extends BaseAdapter {
    ...
    public ReduceListPAdapter(Context context, String type) {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            convertView = mInflater.inflate(R.layout.item_reduce_group, null);
        ...
        String mName = mData.get(position).optString("REAL_NAME");
