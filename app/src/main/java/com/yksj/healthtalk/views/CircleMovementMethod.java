...
public class CircleMovementMethod extends BaseMovementMethod {
    ...
    public CircleMovementMethod(){
        this.textViewBgColor = AppContext.getApplication().getResources().getColor(DEFAULT_COLOR_ID);
        this.clickableSpanBgClor = AppContext.getApplication().getResources().getColor(DEFAULT_CLICKABLEA_COLOR_ID);
    }
