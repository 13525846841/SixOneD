package com.yksj.healthtalk.views.mvp.presenter;

import android.view.View;

import com.yksj.healthtalk.views.CommentItem;
import com.yksj.healthtalk.views.User;
import com.yksj.healthtalk.views.mvp.CommentConfig;
import com.yksj.healthtalk.views.mvp.IDataRequestListener;
import com.yksj.healthtalk.views.mvp.contract.CircleContract;
import com.yksj.healthtalk.views.mvp.modle.CircleModel;
...
//				CommentItem newItem = null;
				...
				newItem.setUser(new User("1","2","sdsdf"));
				newItem.setToReplyUser(new User("1","2","史蒂夫拉萨的家"));
				newItem.setId("22");
				newItem.setContent("@@@@");
