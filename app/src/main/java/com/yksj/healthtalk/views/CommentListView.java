...
import com.yksj.healthtalk.utils.UrlUtils;
...
public class CommentListView extends LinearLayout {
    ...
    public void addDatas(CommentItem item) {
        mDatas.add(item);
        notifyDataSetChanged();
    }
    ...
    private View getView(final int position) {
        ...
        View convertView = layoutInflater.inflate(R.layout.item_comment2, null, false);
        ...
        if (!TextUtils.isEmpty(toReplyName)) {
            if (!HStringUtil.isEmpty(toReplyName)){
                builder.append(" 回复 ");
...
//                                        Toast.makeText(AppContext.getApplication(), textStr + " &id = " + id, Toast.LENGTH_SHORT).show();
                                    }
