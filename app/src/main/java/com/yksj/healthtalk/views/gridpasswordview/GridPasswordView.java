...
import com.yksj.healthtalk.views.gridpasswordview.imebugfixer.ImeDelBugFixedEditText;
...
public class GridPasswordView extends LinearLayout implements PasswordView {
    ...
    private void initAttrs(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        lineWidth = (int) ta.getDimension(R.styleable.gridPasswordView_lineKuan, Util.dp2px(getContext(), 1));
