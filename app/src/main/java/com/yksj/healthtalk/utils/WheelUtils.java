...
import com.yksj.consultation.sonDoc.views.EditTextBox;
import com.yksj.consultation.sonDoc.views.EditTextBox.OnBottomListener;
import com.yksj.consultation.sonDoc.views.OnWheelChangedListener;
...
public class WheelUtils {
     ...
     * 滚轮日历  从现在开始 往前100年
     */
    private static List<Map<String, Object>> getCalendarListForBaby() {
    ...
    public static PopupWindow showThreeDateWheelFromNow(final Context context, final View view, final OnClickListener listener) {
        ...
        final WheelView wheelOne = (WheelView) wheelView.findViewById(R.id.wheel);
        final WheelView wheelTwo = (WheelView) wheelView.findViewById(R.id.wheel_middle);
        final WheelView wheelThree = (WheelView) wheelView.findViewById(R.id.wheel_right);
     ...
     * @return
     */
    public static PopupWindow showThreeBabyDateWheel(final Context context, final View view, final OnClickListener listener) {
        final List<Map<String, Object>> list = getCalendarListForBaby();
        final List<Map<String, Object>> monthList = new ArrayList<Map<String, Object>>();
