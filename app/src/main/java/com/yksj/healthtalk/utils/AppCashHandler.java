...
public class AppCashHandler implements UncaughtExceptionHandler {
	...
	private void saveLogFile(StringBuffer sb) throws IOException{
		if (Environment.getExternalStorageState().equals(
			...
			String root = Environment.getExternalStorageDirectory().toString()+"/HealthTalkDoc/log/";
	...
	public void sendLogToServer(){
		...
		if(file.exists()){
			try {
				...
				file.deleteOnExit();
				//提交异常
				ApiService.doHttpReportAppException(buffer.toString(),null);
			} catch (Exception e) {
				e.printStackTrace();
			}
		}
