...
import com.yksj.consultation.sonDoc.friend.FriendHttpListener;
...
public class FriendHttpUtil {
    ...
    public static void getFriends(final CustomerInfoEntity c,
        ...
        ApiService.doHttpRequestSearchFriends2(c, pageSize,
    ...
    public static void getFriendsByType(final CustomerInfoEntity c,
        ...
        ApiService.doHttpRequestSearchFriends1(c, sourceType,
                new ObjectHttpResponseHandler() {
...
//				DialogUtils.PromptDialogBox(context,context.getString(R.string.att_client), entity);
    ...
    public static void chatFromPerson(final FragmentActivity activity,
                                      final String id, final String name, String orderId) {
        ChatHelperUtils.chatFromPerson(activity, id, name, orderId);
    }
     ...
     *
     * @param context
     * @param object      myDoctors我关注的医生 myReceDoctors我最近联系的医生 myRegDoctors我的预约医生
     *                    myRegHisDoctors我的历史预约医生 "myBuyFailureDoctorsName": "支付失败医生",
     * @param nameIndexs
     * @param nameByIndex
     * @param nameIndexs
     * @param nameByIndex
    ...
    public static void jumpChatFromDy(FragmentActivity context) {
        ...
        entity.setName(AppContext.getAppData().DYHSID_NAME);
        entity.setId(AppContext.getAppData().DYHSID);
