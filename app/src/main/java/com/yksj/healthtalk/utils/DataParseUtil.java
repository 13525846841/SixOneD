...
public class DataParseUtil {
     ...
     * @param
     */
    public static List<MessageEntity> parseGroupMessage(String value, String userId) {
...
//			System.out.println(e.toString());
    ...
    public static CustomerInfoEntity jsonToCustomerInfo2(String josn) {
        ...
        try {
            ...
            mCustomerInfoEntity.setSixOneAccount(object.getString("customerAccounts"));
            ...
            mCustomerInfoEntity.setDoctorBigPicture(object.getString("doctorBigIconbackground"));
            mCustomerInfoEntity.setOfficeCode2(object.optString("doctorOffice2"));
            mCustomerInfoEntity.setAge(object.optString("age"));
            mCustomerInfoEntity.setDoctorWorkaddressCode(object.optString("workLocation"));
            mCustomerInfoEntity.setName(object.optString("doctorRealName"));
            mCustomerInfoEntity.setDoctorTitle(object.optString("doctorTitle"));
            mCustomerInfoEntity.setRoldid(object.optInt("roleId"));
            mCustomerInfoEntity.setSpecial(object.optString("doctorSpecially"));
            ...
            mCustomerInfoEntity.setCenterName(object.getString("centerName"));
            mCustomerInfoEntity.setOfficeCode2(object.getString("doctorOffice2"));
            mCustomerInfoEntity.setTransferGetName(object.optString("TRANSFER_GETNAME"));
            mCustomerInfoEntity.setTransferGetTele(object.optString("TRANSFER_GETTELE"));
            mCustomerInfoEntity.setTransferName(object.optString("TRANSFER_NAME"));
            mCustomerInfoEntity.setTransferCode(object.optString("TRANSFER_CODE"));
            mCustomerInfoEntity.setTransferAddr(object.optString("TRANSFER_ADDR"));
            mCustomerInfoEntity.setSiteId(object.optString("site_ID"));
...
//			System.out.println(e.toString());
    ...
    public static CustomerInfoEntity JsonToDocCustmerInfo(JSONObject object) {
        ...
        mCustomerInfoEntity.setRefusal_reason(object.optString("refusal_reason"));//失败原因
