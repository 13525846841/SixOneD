 ...
 *
 */
public class PwdForgetActivity extends BaseActivity implements OnClickListener{
	...
	public void onClick(View v) {
		...
		case R.id.title_right2:
			...
			ApiService.doHttpWalletSetting(params,new AsyncHander(HTTP.SUBMIT.value));
			break;
		default:
			break;
		}
	...
	private void getAuthCode() {
		...
		if (phone != null && phone.length() == 11 && isDigit(phone)) {
			RequestParams params = new RequestParams();
			params.put("TYPE", "GETCENTERCODE");
			params.put("CENTERID", AppContext.APP_CONSULTATION_CENTERID);
			params.put("TELEPHONE", phone);
			ApiService.doHttpWalletSetting(params,new AsyncHander(HTTP.CODE.value));
		} else {
