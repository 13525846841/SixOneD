 ...
 * with additional parameters by passing a {@link RequestParams} getInstance,
 * and responses can be handled by passing an anonymously overridden
 * {@link AsyncHttpResponseHandler} getInstance.
 * <p>
 * For example:
 * <p>
 * <pre>
...
//      HttpClientParams.setRedirecting(httpParams, true);
    ...
    private void setDefualtHeader() {
        addHeader("system_version", AppUtils.getAppVersionName());
        addHeader("client_type", AppContext.CLIENT_TYPE);
        addHeader("OSType", "1");
    }

    /**
     * Get the underlying HttpClient getInstance. This is useful for setting
    ...
    /**
     * Get the underlying HttpContext getInstance. This is useful for getting
     ...
     *
     * @param cookieStore The CookieStore implementation to use, usually an getInstance of {@link PersistentCookieStore}
     */
     ...
     *
     * @param threadPool an getInstance of {@link ThreadPoolExecutor} to use for queuing/pooling requests.
     */
    ...
    public void addHeader(String header, String value) {
        ...
        ApiConnection.addHeader(header, value);
    }
     ...
     * longer required.
     *
     * @param context               the android Context getInstance associated to the request.
     ...
     * @param responseHandler the response handler getInstance that should handle the response.
     */
     ...
     * @param params          additional GET parameters to send with the request.
     * @param responseHandler the response handler getInstance that should handle
     *                        the response.
     */
    ...
    public void post(Context context, String url, RequestParams params, AsyncHttpResponseHandler responseHandler) {
        LogUtils.d("HEALTHTALK_HTTP", url, params);
    ...
    protected org.apache.http.conn.ssl.SSLSocketFactory createAdditionalCertsSSLSocketFactory() {
        try {
            ...
            final InputStream in = AppContext.getApplication().getAssets().open("my.keystore");
            try {
