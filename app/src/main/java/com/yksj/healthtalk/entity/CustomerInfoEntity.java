...
public class CustomerInfoEntity extends BaseInfoEntity implements Serializable {
    ...
    private String serviceEnd;// 预约结束时间
    private String phonefriendName;// 匹配的电话薄名称
    private String payId;// 订单ID
    private String isSetPwd;//是否设置了钱包密码
    private String  avAcount;//网易云客户账号

    public String getAvAcount() {
        return avAcount;
    }

    public void setAvAcount(String avAcount) {
    ...
    private String refusal_reason;//审核失败原因
    ...
    private int orderOnOff;// 预约标记 1-开；0-关

    private String servicePrice;// 预约价格
    ...
    private String serviceStatus;// 预约服务的状态描述
    private String serviceTime;// 预约开始的时间
    private String serviceStatusCode;// 预约服务的状态码
    ...
    private String serviceTypes;// 预约服务类型
    private String orderServiceTypes;// 医生订制服务类型
    private String qrCode;// 二维码
    private String qrCodeIcon;// 二维码图片
    private String registerCount;// 预约次数,这个在历史预约中显示
    ...
    private String avToken;//网易云token
    private String sixOneAccount;//六一账号
...
//	}
    ...
    public String getSixOneAccount() {
        return sixOneAccount;
    }

    public void setSixOneAccount(String sixOneAccount) {
        this.sixOneAccount = sixOneAccount;
    }
}
