...
public class SlidingTabLayout extends HorizontalScrollView implements ViewPager.OnPageChangeListener{
    ...
    public void setViewPager(ViewPager vp, String[] titles, FragmentActivity fa, Fragment... fragments) {
        List<Fragment> list = Arrays.asList(fragments);
        setViewPager(vp, titles, fa, list);
    }
...
//            v.setPadding((int) mTabPadding, v.getPaddingTop(), (int) mTabPadding, v.getPaddingBottom());
    ...
    public void showMsg(int position, int num) {
        ...
        if (tipView != null) {
            visibalMsgViewByNumber(tipView, num);
    ...
    private void visibalMsgViewByNumber(MsgView msgView, int num) {
        if (msgView == null) {
            return;
        }
    ...
    public void setMsgMargin(int position, float leftPadding, float bottomPadding) {
        ...
        if (tipView != null) {
            ...
            lp.leftMargin = mTabWidth >= 0 ? (int) (mTabWidth / 2 + textWidth / 2 + SizeUtils.dp2px(leftPadding)) : (int) (mTabPadding + textWidth + SizeUtils.dp2px(leftPadding));
            lp.topMargin = mHeight > 0 ? (int) (mHeight - textHeight) / 2 - SizeUtils.dp2px(bottomPadding) : 0;
