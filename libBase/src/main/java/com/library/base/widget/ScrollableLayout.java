...
public class ScrollableLayout extends LinearLayout {
    ...
    private OnStickedChangeListener mStickedChangeListener;
    ...
    public boolean dispatchTouchEvent(MotionEvent ev) {
        ...
        switch (ev.getAction()) {
            ...
            case MotionEvent.ACTION_MOVE:
                ...
                if (mStickedChangeListener != null && isSticked != isSticked()) {
                    DIRECTION direction = mLastY > currentY ? DIRECTION.UP : DIRECTION.DOWN;
                    isSticked = isSticked();
                    mStickedChangeListener.onStickedChange(direction, isSticked);
                }
                mLastX = currentX;
                mLastY = currentY;
                x_move = ev.getRawX();
    ...
    public void computeScroll() {
        if (mScroller.computeScrollOffset()) {
            if (mStickedChangeListener != null && isSticked != isSticked()) {
                isSticked = isSticked();
                mStickedChangeListener.onStickedChange(mDirection, isSticked);
            }
    ...
    public void setStickedChangeListener(OnStickedChangeListener stickedChangeListener) {
        this.mStickedChangeListener = stickedChangeListener;
    }
    ...
    public interface OnStickedChangeListener {
        void onStickedChange(DIRECTION direction, boolean isSticked);
    }
}
